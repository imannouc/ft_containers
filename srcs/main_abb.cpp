...
int main()
{
    ...
    //NOTE - Return iterator to end
    {
        ...
        std::cout << "myvector contains:";
        for (NS::vector<int>::iterator it = myvector2.begin(); it != myvector2.end(); ++it)
            std::cout << ' ' << *it;
        std::cout << '\n';
    }
    ...
    // NOTE - Return size
    {
        std::cout << "------------- vector size  / push back -------------" << std::endl;
        NS::vector<int> myints1;
        for (int i = 0; i < 10; i++){
            myints1.push_back(i);
			std::cout << myints1[i] << "pushed back.\n";
		}
...
//     // NOTE - Construct pair
    ...
    // NOTE - Get allocator
    {
        ...
        m.insert(NS::make_pair(1, "Test1"));
        m.insert(NS::make_pair(2, "Test2"));
        m.insert(NS::make_pair(3, "Test3"));
